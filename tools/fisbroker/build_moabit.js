            ...
            if(!skip){
                ...
                if(!skip){
                    ...
                    if(sources[j].type === "wfs"){
                        page += "<a href='https://raw.githubusercontent.com/sebastian-meier/BerlinRefinedAssets/master/tools/fisbroker/moabit/"+((sources[j].technology.rechneradresse[0].split("/"))[(sources[j].technology.rechneradresse[0].split("/")).length-1])+".min.geojson'>Min.GeoJson</a><br />"+"\n";
                        page += "<a href='https://raw.githubusercontent.com/sebastian-meier/BerlinRefinedAssets/master/tools/fisbroker/moabit/"+((sources[j].technology.rechneradresse[0].split("/"))[(sources[j].technology.rechneradresse[0].split("/")).length-1])+".geojson'>GeoJson</a>"+"\n";
                        page += "<a href='https://raw.githubusercontent.com/sebastian-meier/BerlinRefinedAssets/master/tools/fisbroker/moabit/"+((sources[j].technology.rechneradresse[0].split("/"))[(sources[j].technology.rechneradresse[0].split("/")).length-1])+".csv'>CSV</a><br />"+"\n";
                        ...
                        switch(sources[j].type){
                            ...
                            case 'wms':
                                ...
                                for(var l = 0; l<sources[j].technology.layers.length; l++){
                                    ...
                                    page += "<a href='https://raw.githubusercontent.com/sebastian-meier/BerlinRefinedAssets/master/tools/fisbroker/moabit/"+((sources[j].technology.rechneradresse[0].split("/"))[(sources[j].technology.rechneradresse[0].split("/")).length-1])+"_"+layer.name+".png'>Moabit Karte</a><br />"+"\n";
                                    page += "<a href='https://raw.githubusercontent.com/sebastian-meier/BerlinRefinedAssets/master/tools/fisbroker/moabit/berlin_"+((sources[j].technology.rechneradresse[0].split("/"))[(sources[j].technology.rechneradresse[0].split("/")).length-1])+"_"+layer.name+".png'>Berlin Karte</a>"+"\n";
                    ...
                    fs.writeFileSync("../../../BerlinRefined@github/pages/example/details/"+sources[j].type+"_"+name+".html", page);
...
fs.writeFile("../../../BerlinRefined@github/pages/example/overview.html", overview, function(err) {
