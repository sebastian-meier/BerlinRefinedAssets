        ...
        if(sources[j].category === categories[i]){
            ...
            if(!skip){
                if(!skip){
                    ...
                    fs.writeFileSync("../../../BerlinRefined@github/pages/fisbroker/details/"+sources[j].type+"_"+name+".html", page);
...
fs.writeFile("../../../BerlinRefined@github/pages/fisbroker/overview.html", overview, function(err) {
